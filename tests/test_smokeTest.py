...
class TestSmokeTest():
  ...
  def test_homePageLogo(self):
    self.driver.get("http://127.0.0.1:5500/teton/1.6/index.html")
    self.driver.set_window_size(1455, 909)
  ...
  def test_joinPage(self):
    ...
    self.driver.find_element(By.NAME, "fname").send_keys("Person")
    self.driver.find_element(By.NAME, "lname").send_keys("Ofinterest")
    self.driver.find_element(By.NAME, "bizname").send_keys("Mind Your Own")
    self.driver.find_element(By.NAME, "biztitle").send_keys("Head Chieftain")
  ...
  def test_adminPage(self):
    ...
    self.driver.find_element(By.ID, "username").send_keys("Thiscan\'tberight")
    self.driver.find_element(By.ID, "password").send_keys("Worstpasswordever")
